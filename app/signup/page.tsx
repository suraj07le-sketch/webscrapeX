...
export default function SignUpPage() {
    return (
        <main className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-[#050505]">
            ...
            <div className="absolute -top-[20%] -left-[10%] w-[600px] h-[600px] bg-purple-600/10 blur-[120px] rounded-full -z-10" />
            <div className="absolute -bottom-[20%] -right-[10%] w-[600px] h-[600px] bg-primary/5 blur-[120px] rounded-full -z-10" />
            ...
            >
                ...
                <div className="mt-6 text-center">
                    <p className="text-xs font-medium text-muted-foreground/40 uppercase tracking-widest">
                        Have account?{' '}
                        <Link href="/login" className="text-primary font-black hover:opacity-80 transition-opacity ml-1">
                            Sign In
                        </Link>
                    </p>
                </div>
